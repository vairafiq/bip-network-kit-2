<?php
    ...
    $sd_post = sd_get_business_fields( get_the_ID() );
    $phone           = $sd_post['sd_phone'] ?? '';
    $email           = $sd_post['sd_email'] ?? '';
    $website         = $sd_post['sd_website'] ?? '';
    $address         = $sd_post['sd_address'] ?? '';
    $latitude        = $sd_post['sd_latitude'] ?? '';
    $longitude       = $sd_post['sd_longitude'] ?? '';
    $google_id       = $sd_post['sd_google_id'] ?? '';
    $overall_rating  = $sd_post['sd_overall_rating'] ?? '';
    $total_reviews   = $sd_post['sd_total_reviews'] ?? '';
    $google_reviews  = $sd_post['sd_google_reviews'] ?? '';
    $review_summary  = $sd_post['sd_review_summary'] ?? '';
    $review_details  = $sd_post['sd_review_details'] ?? '';
    $google_images   = $sd_post['sd_google_images'] ?? '';
    $features        = $sd_post['sd_features'] ?? '';
    $business_hours  = $sd_post['sd_business_hours'] ?? '';
    $listed_date     = $sd_post['sd_listed_date'] ?? '';
    $expire_date     = $sd_post['sd_expire_date'] ?? '';
        ...
        <div class="sd-archive-item-content">
            <header class="sd-archive-item-header">
                ...
                <?php if( $overall_rating) {
                    echo sd_get_overall_rating( $overall_rating, $total_reviews );
                } ?>
                <!-- </span> -->
